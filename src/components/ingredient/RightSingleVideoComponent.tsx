...
const RightSingleVideoComponent = (props: Props) => {
    const { comments, isFavorite, isLiked, avatar, commentsQty, favoriteQty, heartQty, shareQty, uid, onClickButtonEvent, userName } = props;
    const bottomTabHeight = useBottomTabBarHeight();

    return (
        <View
            style={[styles.wrapper, { height: (SCREEN_HEIGHT - bottomTabHeight - 105) / 2 }]}
        >
            <ButtonAvatarComponent uid={0} avatar={avatar} isFollowing={false} addButton={true} name={userName} />
