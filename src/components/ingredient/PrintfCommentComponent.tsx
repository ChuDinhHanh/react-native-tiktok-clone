                ...
                renderItem={({ item }) => (
                    <React.Fragment key={item.id}>
                        ...
                        {item.children && item.children.length !== 0 && <>
                            {
                                <PrintfChildrenCommentComponent comments={item.children} isFather={true} />
                            }
                        </>
                        }
                    </React.Fragment>
...
// con
const PrintfChildrenCommentComponent = React.memo((props: { comments: any, isFather: boolean }) => {
            ...
            >
                ...
                <View style={{ width: '87%' }}>
                    <RowComponent
                        ...
                        <View style={{ width: 30, height: 1, backgroundColor: Colors.BLACK }} />
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <React.Fragment key={item.id}>
                            ...
                            {item.children && item.children.length !== 0 && <PrintfChildrenCommentComponent comments={item.children} isFather={false} />}
                        </React.Fragment>
                    )}
                />
            }
