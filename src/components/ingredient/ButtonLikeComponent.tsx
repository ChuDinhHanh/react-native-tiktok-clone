        ...
        <>
            {
                ...
                >
                    <ButtonComponent
                        previousImage={
                            <IconAntDesign name='heart' size={fontSize ?? 32} color={_liked ? Colors.PINK : Colors.WHITE} />
                        }
                    ...
                    : <RowComponent>
                        {
                            _liked ? <ButtonComponent
                                previousImage={
                                    <IconAntDesign name='heart' size={fontSize ?? 32} color={Colors.PINK} />
                                }
                                onPress={() => handleLikeEvent()}
                            /> : <ButtonComponent
                                previousImage={
                                    <IconAntDesign name='hearto' size={fontSize ?? 32} color={Colors.BLACK} />
                                }
                                onPress={() => handleLikeEvent()}
                            />
                        }
