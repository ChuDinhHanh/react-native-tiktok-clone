...
import { INPUT_OF_COMMENT, INPUT_OF_HOME_SCREEN, INPUT_OF_SHOP_SCREEN } from '../../constants/Variables';
...
const InputComponent = (props: Props) => {
    ...
    const { onPress, placeholder, iconRight, paddingLeft, paddingRight, type, buttonRight
    } = props;
    ...
    switch (type) {
            ...
            return (
                <>
                    <TextInput
                        ...
                        style={[styles.input, { paddingLeft: paddingLeft ?? 15, paddingRight }]}
                    />
                    <TouchableOpacity
                        style={styles.icon}
        ...
        case INPUT_OF_HOME_SCREEN:
            return <RowComponent justify={'space-between'} alignItems='center'>
                <View style={styles.wrapperInputHomeSearch}>
                    <IconAntDesign size={25} color={Colors.BLACK} name='search1' style={{ paddingHorizontal: 5 }} />
                    <TextInput
                        ref={inputRef}
                        value={comments}
                        onChangeText={(val) => setComments(val)}
