...
const ProductItem = (props: Props) => {
    ...
    return (
        <TouchableOpacity
            onPress={() => onPressOnProduct(item.id)}
        >
            <View
                key={item.id}
            ...
            >
                ...
                <SessionComponent padding={5}>
                    <Text
                        ...
                        ellipsizeMode="tail"
                        style={
                            [styles.text, { maxWidth: (SCREEN_WIDTH - 20) / 2 - 10 }]
                        }>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque, deleniti. Nesciunt iure deserunt nulla mollitia! Perferendis facere magnam assumenda cum cupiditate delectus excepturi, impedit quis tenetur dolorum dicta quidem sed!
                    </Text>
                    <RowComponent justify={'flex-start'} alignItems='center'>
                        <TextComponent
                            text={formatVietNamCurrency(204000) + "đ"}
                            color={Colors.PINK}
                            fontWeight='bold'
                        />
