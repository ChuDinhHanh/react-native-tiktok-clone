        ...
        >
            <SessionComponent>
                <RowComponent justify='space-between' alignItems='center'>
                    <ButtonComponent
                        isVertical={true}
                        titleChildren={<TextComponent text='Cửa hàng' color={Colors.BLACK} />}
                        onPress={() => { console.log() }}
                        previousIcon={<IconEntypo name='shop' color={Colors.BLACK} size={20} />}
                    />
                    <ButtonComponent
                        isVertical={true}
                        titleChildren={<TextComponent text='Cửa hàng' color={Colors.BLACK} />}
                        onPress={() => { console.log() }}
                        previousIcon={<IconAntDesign name='message1' color={Colors.BLACK} size={20} />}
                    />
                    <ButtonComponent
                        paddingVertical={3}
