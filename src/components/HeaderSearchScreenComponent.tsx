        ...
        <View style={{
            ...
            <RowComponent justify={'space-between'} alignItems='center'>
                ...
                <InputComponent
                    ...
                    iconRight={<IconAntDesign size={21} color={Colors.BLACK} name='closecircle' style={{ paddingHorizontal: 5 }} />}
                    type={INPUT_OF_HOME_SCREEN}
                    buttonRight={
                        <TextComponent text='Tìm kiếm' fontSize={17} fontWeight='bold' color={Colors.PINK} />
                    }
                />
            </RowComponent>
        </View>
