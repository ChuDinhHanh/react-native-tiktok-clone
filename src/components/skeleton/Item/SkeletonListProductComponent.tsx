...
const SkeletonListProductComponent = (props: { needTwoLine: boolean }) => {
    ...
    >
        <SkeletonLineComponent height={30} width={'42.5%'} backgroundColor={Colors.GREY_2} borderRadius={10} />
        <SpaceComponent height={10} />
        <RowComponent justify={'space-around'}>
            <SkeletonProductComponent needTwoLine={props.needTwoLine} width={80} height={80} borderRadius={10} />
            <SkeletonProductComponent needTwoLine={props.needTwoLine} width={80} height={80} borderRadius={10} />
            <SkeletonProductComponent needTwoLine={props.needTwoLine} width={80} height={80} borderRadius={10} />
            <SkeletonProductComponent needTwoLine={props.needTwoLine} width={80} height={80} borderRadius={10} />
        </RowComponent>
