...
import { followingScreenId, forYouScreenId, friendScreenId, liveScreenId, searchScreenId } from '../constants/Variables'
...
const HeaderHomeScreenComponent = (props: { onChooseOptionEvent: (idChoose: number) => void }) => {
            ...
            <SessionComponent>
                ...
                >
                    <ButtonComponent
                        ...
                        previousIcon={<IconMaterialIcons name='live-tv' size={28} color={Colors.WHITE} />}
                    />
                    <ButtonComponent
                        textDecoration={true}
                        ...
                        titleChildren={
                            <TextComponent
                                color={activeId !== friendScreenId ? Colors.GREY_PALE : Colors.WHITE}
                                text='Bạn bè'
                                fontWeight='bold'
                    ...
                    <ButtonComponent
                        ...
                        titleChildren={
                            <TextComponent
                                color={activeId !== followingScreenId ? Colors.GREY_PALE : Colors.WHITE}
                                text='Đang follow'
                                fontWeight='bold'
                                fontFamily='sanserif'
                            />
                    ...
                    <ButtonComponent
                        ...
                        titleChildren={
                            <TextComponent
                                color={activeId !== forYouScreenId ? Colors.GREY_PALE : Colors.WHITE}
                                text='Dành cho bạn'
                                fontWeight='bold'
                                fontFamily='sanserif'
                            />
                    ...
                    <ButtonComponent
                        ...
                        previousIcon={<IconAntDesign name='search1' size={28} color={Colors.WHITE} />}
                    />
                </RowComponent>
            </SessionComponent>
        </View>
